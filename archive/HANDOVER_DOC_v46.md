...
- **Sprints RET-1/2/3 (June 20, 2026) — pending verification / next steps:**
  ...
  - **Lever (ii) of SECOND-USE RETENTION STRATEGY §5 shipped in Sprint RET-4 — see dated entry at top.** Levers (i) and (iii) remain parked pending scoping with Ken; do not start either without that conversation first.
