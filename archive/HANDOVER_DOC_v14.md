# QUORUM — Handover Document v14
### Date: May 2026 | Status: Sprint 15a complete (Calibration Sparklines)
...
## DATABASE SCHEMA (all tables, current as of Sprint 15a)
...
app/
  page.tsx               — landing / decision submission form (pre_decision_confidence slider live)
...
| **15a** | **Calibration Sparklines in Mirror — ✅ PASSED (see below)** |

---

## CURRENT STATUS (as of Sprint 15a)

### ✅ Live and working

Everything from Sprints 11a–14, plus:

**Sprint 15a — Calibration Sparklines** (`app/api/mirror/calibration/route.ts`, `components/CalibrationSparkline.tsx`)
