...
TD-LD-6: Three immediate actions are approved and active now, independent of how the model debate resolves: (a) market/gap research, (b) website copy rebuild, (c) third-party data privacy audit quote. See Part 5.
...
## PART 5 — IMMEDIATE ACTIONS (ACTIVE NOW)
...
## PART 6 — OPEN QUESTIONS FOR NEXT SESSION (to actually debate, not yet decided)
...
6. How do buyers actually self-select into T1a / T1b / Tier 2 / Tier 3 — a sales conversation, a pricing-page toggle, or an onboarding questionnaire? Needs a GTM answer, not just a technical one.

---

## PART 7 — PARKED (LOGGED, NOT ACTIVE)
...
- Get hardware sizing/cost numbers for T1a and T1b (Open Question 1) before Tier 1 can be priced or pitched.
- Build the GTM-facing answer to Open Question 6 (how buyers self-select a tier) — likely belongs in GTM Playbook V15 once decided, not just here.
